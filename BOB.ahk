...
global licenseFile := A_AppData "\BOB\license.dat"
...
; ── Manual Bob zmienne ──────────────────────────────────────────
global MB_IniFile     := A_AppData "\BOB\manualbob_config.ini"
global MB_hotkey      := "e"   ; klawisz wczytywany z INI przy starcie
global MB_HistFile    := A_AppData "\BOB\manualbob_historia.txt"
global MB_TotalFile   := A_AppData "\BOB\manualbob_total.dat"
global MB_webhook     := ""
...
global CG_IniFile     := A_AppData "\BOB\critglove_config.ini"
global CG_hotkey      := "RButton"   ; klawisz wczytywany z INI przy starcie
global CG_HistFile    := A_AppData "\BOB\critglove_historia.txt"
global CG_TotalFile   := A_AppData "\BOB\critglove_total.dat"
global CG_webhook     := ""
...
; ── Replica Bob zmienne ──
global R_IniFile     := A_AppData "\BOB\replica_config.ini"
global R_HistFile    := A_AppData "\BOB\replica_historia.txt"
global R_TotalFile   := A_AppData "\BOB\replica_total.dat"
global R_webhook     := ""
...
; ── BOB zmienne ──
global P_IniFile     := A_AppData "\BOB\portal_config.ini"
global P_HistFile    := A_AppData "\BOB\portal_historia.txt"
global P_TotalFile   := A_AppData "\BOB\portal_total.dat"
global P_webhook     := ""
...
; ── Debug / Security ──
global debugCodeFile := A_AppData "\BOB\debug_code.dat"
global sentInfoFile  := A_AppData "\BOB\sent_info.dat"   ; flaga — info wysłane raz
global debugCode     := ""
...
; ── Trap/Brick zmienne ──
global T_IniFile      := A_AppData "\BOB\trap_config.ini"
global T_HistFile     := A_AppData "\BOB\trap_historia.txt"
global T_TotalFile    := A_AppData "\BOB\trap_total.dat"
global T_webhook      := ""
...
global O_IniFile      := A_AppData "\BOB\obby_config.ini"
global O_HistFile     := A_AppData "\BOB\obby_historia.txt"
global O_TotalFile    := A_AppData "\BOB\obby_total.dat"
global O_webhook      := ""
...
BuildPortalGUI() {
    ...
    W := 300
    gui1 := Gui("+AlwaysOnTop -MaximizeBox", "BOB — " APP_VERSION)
